...
<head>
    ...
    <meta name="description"
        content="Portofolio Agus Tinus Turnip, seorang Full-Stack Developer yang berspesialisasi dalam Laravel, Tailwind CSS, dan pengembangan aplikasi mobile.">
    ...
    <main>
        <section id="introduction" class="bg-gray-light dark:bg-gray-darker">
            <div class="container mx-auto px-6 min-h-screen flex items-center justify-center">
                ...
                <div class="py-20 w-full grid grid-cols-1 gap-8 items-center lg:grid-cols-5 lg:gap-16">
                    ...
                    <div class="lg:col-span-2 lg:order-2 flex justify-center items-center fade-in-element"
                        data-animation="right">
                        <img src="{{ asset('images/undraw_web-devices.svg') }}"
                            alt="Ilustrasi Pengembangan Web dan Mobile" class="w-full max-w-sm md:max-w-md">
                    </div>

                    <!-- Kolom Teks - Muncul kedua di mobile -->
                    <div class="lg:col-span-3 lg:order-1 text-center lg:text-left fade-in-element"
                        data-animation="left">
            ...
            <div class="container mx-auto px-6">
                <div class="text-center max-w-3xl mx-auto mb-16 fade-in-element">
                    ...
                    <p class="font-body text-xl text-gray-text dark:text-gray-300">
                        Saya menawarkan solusi end-to-end, mulai dari pengembangan aplikasi mobile native hingga backend
                        web
                        yang tangguh dan skalabel.
                    </p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="group bg-gray-light dark:bg-gray-dark p-8 rounded-xl shadow-lg transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl fade-in-element"
                        ...
                        <p class="font-body text-base text-gray-text dark:text-gray-400 mb-6">
                            Membangun aplikasi native dan cross-platform yang responsif dan kaya fitur, dengan fokus
                            pada
                    ...
                    <div class="group bg-gray-light dark:bg-gray-dark p-8 rounded-xl shadow-lg transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl fade-in-element"
                        ...
                        <h3 class="font-heading text-2xl font-bold text-gray-heading dark:text-white mb-3">Tools &
                            DevOps
                        </h3>
                        <p class="font-body text-base text-gray-text dark:text-gray-400 mb-6">
        ...
        <section id="projects" class="bg-gray-light dark:bg-gray-dark py-24">
            <div class="container mx-auto px-6">
                ...
                <div class="text-center max-w-3xl mx-auto mb-16 fade-in-element">
                    <h2 class="font-heading text-5xl font-extrabold text-gray-heading dark:text-white mb-4">Proyek
                        Unggulan</h2>
                    <p class="font-body text-xl text-gray-text dark:text-gray-300">
                ...
                <!-- Container Grid untuk Kartu Proyek -->
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">

                    <!-- KARTU PROYEK 1 -->
                    <div class="group bg-white dark:bg-gray-dark rounded-xl shadow-lg overflow-hidden transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl fade-in-element"
                        style="animation-delay: 100ms;">
                        <div class="relative">
                            <img src="https://images.unsplash.com/photo-1587620962725-abab7fe55159?q=80&w=1931&auto=format&fit=crop"
                                alt="Screenshot Proyek E-Commerce Kamera" class="w-full h-56 object-cover">
                        ...
                        <div class="p-6">
                            ...
                            <p class="font-body text-base text-gray-text dark:text-gray-400 mb-6">Platform e-commerce
                                fungsional dengan fitur katalog produk, keranjang belanja, dan halaman checkout yang
                                responsif.</p>
                            <div class="flex flex-wrap gap-2">
                                <span
                    ...
                    </div> <!-- </div> ekstra sudah dihapus. -->

                    <!-- KARTU PROYEK 2 -->
                    <div class="group bg-white dark:bg-gray-dark rounded-xl shadow-lg overflow-hidden transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl fade-in-element"
                        style="animation-delay: 200ms;">
                        <div class="relative">
                            <img src="https://images.unsplash.com/photo-1480694313141-fce5e697ee25?q=80&w=1887&auto=format&fit=crop"
                                alt="Screenshot Aplikasi Task Management" class="w-full h-56 object-cover">
                            <!-- ... konten overlay ... -->
                        </div>
                        <div class="p-6">
                            <h3 class="font-heading text-2xl font-bold text-gray-heading dark:text-white mb-2">Aplikasi
                                Task Management</h3>
                            <p class="font-body text-base text-gray-text dark:text-gray-400 mb-6">Aplikasi web untuk
                                mengelola tugas harian, dibuat dengan TALL Stack (Tailwind, Alpine, Livewire, Laravel).
                            </p>
                            <div class="flex flex-wrap gap-2">
                                <span
                    ...
                    <div class="group bg-white dark:bg-gray-dark rounded-xl shadow-lg overflow-hidden transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl fade-in-element"
                        ...
                        <div class="relative">
                            <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop"
                                alt="Screenshot Proyek Ketiga" class="w-full h-56 object-cover">
                            <!-- ... konten overlay ... -->
                        </div>
                        <div class="p-6">
                            <h3 class="font-heading text-2xl font-bold text-gray-heading dark:text-white mb-2">
                                Dashboard Analitik</h3>
                            <p class="font-body text-base text-gray-text dark:text-gray-400 mb-6">Visualisasi data
                                interaktif untuk memantau metrik bisnis penting, dibangun menggunakan Vue.js dan
                                Inertia.js.</p>
                            <div class="flex flex-wrap gap-2">
                                <span
                ...
                </div> <!-- Penutup container grid -->
            </div>
        </section>
        <section id="contact" class="bg-white dark:bg-gray-darker py-24 sm:py-32">
            <div class="container mx-auto px-6">
                <div class="max-w-4xl mx-auto text-center fade-in-element">
                    <p
                        class="font-body font-bold text-primary-600 dark:text-primary-400 uppercase tracking-widest mb-4">
                        Punya Ide?
                    </p>
                    <h2
